    ...
    return (
      <section id="our-team">
        <Container>
          ...
          <Row>
            {
              [...Array(8).keys()].map(ign => <TeamMember key={ign} name="Stephen Haire" title="Coffee Maker" imgPath="https://media.licdn.com/dms/image/C4D03AQH5wicq8OQYAQ/profile-displayphoto-shrink_800_800/0?e=1569456000&v=beta&t=o5CEeZmvcaiHDtsYjjKJZtagA9gAOb_SBGFgDh4qvMA"/>)
            }
          </Row>
        </Container>
      </section>
